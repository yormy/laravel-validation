...
namespace Yormy\LaravelValidation\Http\Controllers;
...
class ReferrerOverviewController extends Controller
{
    ...
    {
        $referrerClass = config('laravel-validation.models.referrer.class');
        ...
        foreach ($allReferrers as $referrerModel) {
            ...
            $referrer['created_at'] = $lastAward->get($referrerId, 0)->format(config('laravel-validation.datetime_format'));
        ...
        return view('laravel-validation::admin.overview', [
